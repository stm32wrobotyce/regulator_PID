...
int pid_calculate(pid_str *pid_data, int setpoint, int process_variable)
{
	...
	d_term = (float)(pid_data->Kd * (process_variable - pid_data->previous_variable));		//odpowiedź członu różniczkującego
	...
	pid_data->previous_variable = process_variable;											//aktualizacja zmiennej z poprzednią wartością zmierzoną
